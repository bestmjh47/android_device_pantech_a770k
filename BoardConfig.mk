COMMON_GLOBAL_CFLAGS += -Da770k -DNEED_UMS_ENABLE
TARGET_SPECIFIC_HEADER_PATH := device/pantech/a770k/include
...
-include vendor/pantech/a770k/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := a770k
...
# Vibrator
BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/pantech/a770k/vibrator/vibrator.c
...
BOARD_EGL_CFG := device/pantech/a770k/configs/egl.cfg
...
TARGET_PREBUILT_KERNEL := device/pantech/a770k/prebuilt/kernel
...
BOARD_CUSTOM_GRAPHICS := ../../../device/pantech/a770k/recovery/graphics.c
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/pantech/a770k/recovery/recovery_keys.c
