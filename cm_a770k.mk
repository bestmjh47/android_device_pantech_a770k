...
$(call inherit-product-if-exists, vendor/pantech/a770k/a770k-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/pantech/a770k/overlay
...
# Taskmanager
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/prebuilt/JobManager.apk:/system/app/JobManager.apk \

# Vold
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/vold.fstab:system/etc/vold.fstab

# KoreanIME (Latest version - 2013/12/27 (KST))
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/prebuilt/GoogleKoreanIME.apk:/system/app/LatinIME.apk \
...
# Keylayout (Edited for A770K/A760S by bestmjh47)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/idc/qwerty.idc:/system/usr/idc/qwerty.idc \
    $(LOCAL_PATH)/idc/qwerty2.idc:/system/usr/idc/qwerty2.idc \
    $(LOCAL_PATH)/idc/cyttsp-i2c.idc:/system/usr/idc/cyttsp-i2c.idc \
    $(LOCAL_PATH)/keylayout/qt602240_ts_input_ef34k.kl:/system/usr/keylayout/qt602240_ts_input_ef34k.kl \
...
# Misc Libs(Only for Jellybean - 4.1.2)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/libs/libcamera_client.so:/system/lib/libcamera_client.so \
    $(LOCAL_PATH)/libs/libhardware_legacy.so:/system/lib/libhardware_legacy.so \
    $(LOCAL_PATH)/libs/libinput.so:/system/lib/libinput.so 
...
# I am bestmjh47!!
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/bestmjh47/CREDITS:/system/CREDITS \
